...
@section('content')
    ...
    <section class="home">
        <div style="margin-inline: auto; display: grid; grid-template-columns: auto auto; gap: 10px;">
            <div style="padding: 10px; border: 2px solid tomato; border-radius: 10px; margin-block: 5px; width: 500px;">
                <div
